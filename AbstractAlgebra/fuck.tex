...
\begin{adjustwidth}{0.5cm}{}
  ...
  \begin{align*}
    % \text{The }\text{action} \quad \wideOarc{ABC} \quad \text{ induces the permutation } \quad CBA. \\
    % \text{The }\text{action} \quad \wideOarc{AB}C \quad \text{ induces the permutation } \quad BAC. \\
    % \text{The identity }\text{element } \quad ABC \quad \text{ induces the permutation } \quad ABC.
  \end{align*}
