...
% \section{Day 6}
%
% A group $(S, \ast)$ is called \textbf{finite} if $S$ is a finite set, and \textbf{infinite} otherwise. For instance, $(\mathbb{Z}, +)$ is an infinite group, while the set of permutations $S_{n}$ is a finite group. It's called the \textbf{symmetric group}, and is possibly the most important (and complicated) finite group.
%
% % --------------------------------------------- %
%
% \section{Day 6}
