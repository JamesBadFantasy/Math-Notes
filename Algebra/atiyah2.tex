...
An $R$-module is \textbf{faithful} if $\Ann M = 0$. The annihilator of $R$ may change depending on the ring --- if $\Ann M = \mathfrak{a}$, then $M$ is faithful as an $R \, / \, \mathfrak{a}$ module.
